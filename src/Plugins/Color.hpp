#ifndef PLUGINS_COLOR_HPP
#define PLUGINS_COLOR_HPP
...
class Color{
    ...
    public:
        ...
        static constexpr Color fromHSV(uint32_t h, uint8_t s, uint8_t v, uint8_t alpha = 255)
        {
            Color ret = {};
