...
namespace aGL {
    ...
    public:
        ...
        EventHandlerState onPaintEvent(const Event* e) override { surface->drawRect({5, 220, 60, 20}, currentColor_); return ContainerWidget::onPaintEvent(e);}
    ...
    {
    public:
        ColorScroll(uint32_t x = 0, uint32_t y = 0, Widget* parent = nullptr) : Widget({x, y, 20,200}, parent) {}
        EventHandlerState onPaintEvent(const Event* ) override;
        EventHandlerState onMouseButtonPressEvent(const Event* ) override;
